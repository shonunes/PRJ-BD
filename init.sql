...
ALTER TABLE specialty_hierarchy ADD CONSTRAINT specialty_hierarchy_fk2 FOREIGN KEY (specialty_name) REFERENCES specialty(name);
ALTER TABLE doctor_specialty ADD CONSTRAINT specialty_fk1 FOREIGN KEY (doctor_cc) REFERENCES doctor(cc);
ALTER TABLE doctor_specialty ADD CONSTRAINT specialty_fk2 FOREIGN KEY (specialty_name) REFERENCES specialty(name);
ALTER TABLE nurse_hierarchy ADD CONSTRAINT nurse_hierarchy_fk1 FOREIGN KEY (cc_nurse) REFERENCES nurse(cc);
ALTER TABLE nurse_hierarchy ADD CONSTRAINT nurse_hierarchy_fk2 FOREIGN KEY (cc_boss) REFERENCES nurse(cc);
